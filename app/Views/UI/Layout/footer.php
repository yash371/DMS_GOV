...
<script src="<?=PUBLIC_URL?>assets/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
...
<script src="<?=PUBLIC_URL?>assets/plugins/jvectormap-next/jquery-jvectormap.min.js" type="text/javascript"></script>
<script src="<?=PUBLIC_URL?>assets/plugins/jvectormap-content/world-mill.js" type="text/javascript"></script>
<script src="<?=PUBLIC_URL?>assets/plugins/apexcharts/dist/apexcharts.min.js" type="text/javascript"></script>
<script src="<?=PUBLIC_URL?>assets/js/demo/dashboard.demo.js" type="text/javascript"></script>
